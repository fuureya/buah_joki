...
#text{
  ...
  <title>YazaShop</title>
  <link rel="icon" href="https://www.freeiconspng.com/uploads/discord-metro-style-icon-0.png">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="index.php">
        ...
        <!-- <img src="https://www.freeiconspng.com/uploads/discord-metro-style-icon-0.png" alt="Custom Icon" style="height: 2rem;"> -->
        <img src="https://www.freeiconspng.com/uploads/discord-metro-style-icon-0.png" style="height: 2rem;">
        </div>
        <div class="sidebar-brand-text mx-3">YazaShop</div>
      </a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link" href="pos.php" role="button">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Store</span>
              </a>
            </li>
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <?php
                  ...
                  elseif($_SESSION['GENDER']=='Wallmart bag'){
                    echo 'src="https://i5.walmartimages.com/seo/Blue-Reusable-Shoppping-Bag_831d5bcf-758d-4825-a481-ecf6ca85b413.e98a5b037446ae0da5820e356202ba22.jpeg?odnHeight=768&odnWidth=768&odnBg=FFFFFF"';
                  }
                  else{
