          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="submit" class="btn btn-primary btn-block">PROCEED TO PAYMENT</button><br>
                <button type="submit" class="btn btn-primary btn-block">CETAK STRUK BELANJA</button>
              </div>
            </div>
          </div>
        </div>
